...
export const BUFF_TYPES = {
  attack: {
    ...
    effects: [
      ...
      { key: 'attack_bonus', label: '攻击加值', dataType: 'object', subSelect: 'numberAndAdvantage' },
      ...
      { key: 'save_bonus', label: '豁免检定', dataType: 'object', subSelect: 'abilityScoresAndAdvantage' },
      { key: 'adv_save', label: '豁免检定优势', dataType: 'boolean' },
      { key: 'skill_bonus', label: '技能检定', dataType: 'object', subSelect: 'skillsAndAdvantage' },
  ...
  damage: {
    ...
    effects: [
      ...
      { key: 'ignore_resistance', label: '无视伤害抗性', dataType: 'array', subSelect: 'damageType' },
  ...
  attribute: {
    ...
    effects: [
      ...
      { key: 'flight_speed', label: '飞行速度', dataType: 'object', subSelect: 'flightSpeed' },
      { key: 'reach_bonus', label: '攻击距离', dataType: 'number' },
      { key: 'init_bonus', label: '先攻', dataType: 'number' },
      { key: 'save_dc_bonus', label: 'DC', dataType: 'object', subSelect: 'numberAndAdvantage' },
      { key: 'spell_attack_bonus', label: '法术攻击加值', dataType: 'object', subSelect: 'numberAndAdvantage' },
  ...
  condition: {
    ...
    effects: [
      ...
      { key: 'concentration', label: '专注', dataType: 'object', subSelect: 'numberAndAdvantage' },
...
/** 优势/劣势选项（用于 numberAndAdvantage 等） */
