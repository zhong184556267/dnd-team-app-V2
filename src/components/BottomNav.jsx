...
export default function BottomNav() {
  ...
  return (
    <nav className="fixed bottom-0 left-1/2 z-40 w-[1180px] min-w-[1180px] -translate-x-1/2 bg-[#2D3748] border-x border-t border-white/10 safe-area-pb shadow-[0_-4px_20px_rgba(0,0,0,0.5)]">
      <div className="flex h-14 w-full items-center justify-around px-1 sm:px-2">
        {tabs.map((tab) => {
