 ...
 * 统一深色容器，内部有明确分区与层级
 */
export function CurrencyGrid({ balances, title, extraClass = '', titleClass }) {
  return (
    <div className={`rounded-xl bg-dnd-card border border-white/10 overflow-hidden ${extraClass}`}>
      ...
      <div className="p-3 pt-0 space-y-3">
        {/* 核心资产区：金币居中突出 */}
        <div className="rounded-lg bg-gradient-to-b from-amber-950/20 to-transparent border border-amber-500/20 p-2">
